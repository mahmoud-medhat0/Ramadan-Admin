        ...
        <ul id="sidebar_menu" class="metismenu">
            <li class="">
                ...
                <ul class="mm-collapse">
                    <li><a href="{{ route('AdminsIndex') }}">Admin List</a></li>
                    <li><a href="{{ route('AdminsAdd') }}">Add New Admin</a></li>
                </ul>
            </li>
            {{-- <li class="">
                <a class="has-arrow" href="#" aria-expanded="false">
            ...
            <li class="">
                ...
                <ul class="mm-collapse">
                    <li><a href="{{ route('QuestionShow') }}">Questions list</a></li>
                    <li><a href="{{ route('QuestionAdd') }}">Record New Question</a></li>
                </ul>
            </li>
            <li class="">
                <a class="has-arrow" href="#" aria-expanded="false">
                ...
                <ul class="mm-collapse">
                    <li><a href="{{ route('AnswersShow') }}">Answers List</a></li>
                </ul>
            </li>
            {{-- <li class="">
                <a class="has-arrow" href="#" aria-expanded="false">
