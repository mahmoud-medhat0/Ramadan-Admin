...
@section('title', 'List Of Answers record')
@section('css')
                            ...
                            <tr class="alert" role="alert">
                                ...
                                <td>
                                    <div class="action_btns d-flex" bis_skin_checked="1">
                                        <form
                                        action="{{ route('AnswerData',$record->id) }}"
                                             method="get">
                                            <button class="action_btn"><i class="far fa-eye"></i></button>
                                        </form>
                                        <form
                                        action="{{ route('AnswersPrint',$record->id) }}"
                                         method="get">
                                            <button class="action_btn"><i class="fas fa-print"></i></button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
